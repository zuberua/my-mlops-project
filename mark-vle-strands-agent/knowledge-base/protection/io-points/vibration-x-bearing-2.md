# VIBRATION_X_BEARING_2

## Metadata
- **Block**: Protection
- **I/O Type**: Analog Input
- **Tag**: VIBRATION_X_BEARING_2
- **Hardware**: TRLY Slot 6 Ch 3
- **Signal Range**: 0-25 mm/s

## Description

Bearing 2 vibration X-axis

## Logic Implementation

### Purpose

Detects bearing wear and imbalance
...
```
RMS calculation with frequency analysis
```
