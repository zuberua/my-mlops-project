...
- **Tag**: TNH_SPEED_3
- **Hardware**: TANU Slot 3 Ch 3
- **Signal Range**: 0-6000 RPM

## Description

Redundant turbine speed sensor 3

## Logic Implementation

### Purpose

Backup speed measurement for triple redundancy
...
```
Frequency to RPM conversion with voting
```
